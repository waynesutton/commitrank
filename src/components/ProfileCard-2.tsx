      ...
      <div className="max-w-7xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="mb-12">
          <div className="flex gap-4 max-w-2xl mx-auto">
            ...
            <button
              ...
              {fetchProfileMutation.isPending ? "Loading..." : "Generate Card"}
            </button>
          </div>
          ...
          <div className="flex-1">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {visibleProfiles.map((data, index) => (
                <div key={index} ref={(el) => (profileRefs.current[data.profile.login] = el)}>
                  <ProfileCard
        ...
        <footer className="mt-16">
          ...
          <div className="text-center text-sm text-gray-500">
            <p className="mb-4">Powered by convex.dev</p>
            <div className="flex justify-center gap-6">
              <a
                href="https://twitter.com/commitquest"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://discord.gg/commitquest"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-[#222222] transition-colors">
